namespace DAL.DbExpressions
{
    public class SqlExpressions : IDbExpressions
    {
        ...
        public string GetUsersByLogin(string login) => $"SELECT * FROM Users WHERE Login='{login}'";
        ...
        public string GetFilesByCategory(string category) => $"SELECT * FROM Files WHERE Category='{category}'";
